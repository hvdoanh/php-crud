    ...
    <div class="row">
        <div class="col-12 mb-4 mb-lg-0">
            <div class="card">
                <div class="card-body">
                    <div class="container">
                        <form action="/admin/categories/update/{{ $cate['id'] }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    ...
                                    <img src="{{ file_url($cate['img']) }}" width="100px" alt="">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="is_active" class="col-4 col-form-label">Is Active</label>
                                <div class="col-8">
                                    <input type="checkbox" class="form-control" @checked($cate['is_active'])
