...
class ProductController extends Controller
{
      ...
      public function delete($id)
      {
            ...
            if ($pro['img_thumbnail'] && file_exists($pro['img_thumbnail'])) {
                  unlink($pro['img_thumbnail']);
            }
      ...
      public function edit($id)
      {
            ...
            $title = 'Trang cập nhật products';

            $categories = $this->category->getCategoryOnlyActive();

            return view(
                  'admin.products.edit',
                  compact('pro', 'title', 'categories')
            );
      }
      ...
      public function update($id)
      {
            ...
            try {
                  ...
                  if (is_upload('img_thumbnail')) {
                        ...
                        $data['img_thumbnail'] = $pro['p_img_thumbnail'];
                  }
